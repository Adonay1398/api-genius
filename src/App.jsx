      ...
      const response = await fetch(
        ...
        /* {
          ...
          headers: {
            ...
            'Host': 'api.genius.com',
            'Authorization': 'Bearer Im4q84yh9qRAjD9Ug6EyO6SQ5akYXKeQqRDQtJZ_upWRfU10vcsIGlyEy4hN7kvj',
          ...
          <div className='card-grid'> 
              ...
              {tracks.map((result) => (
                ...
                <li><span>Fecha: </span>{result.result.release_date_for_display}</li>
                  {/* <button>obtener letra</button> */}
                  {/* <div className="letra">
                    <input type="checkbox" id="show-lyrics" />
                    <label for="show-lyrics">Mostrar letra</label>
                    <p id="lyrics" hidden={!document.getElementById('show-lyrics').checked}>
                      {result.lyrics.split('\n').map((line, index) => (
